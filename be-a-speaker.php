					...
					if (in_array($fileActualExt, $allowed)) {
						if ($fileError === 0) {
							if ($fileSize < 1000000) {
								...
								if (empty($output)) {								
				                    $to      = 'speaker@bitfreesummit.africa';
                                    ...
                                    //if (mail($to, $subject, $body, $headers)) {
    					                $query = "
    					                    INSERT INTO `bfs_speaker`(`speaker_name`, `speaker_company`, `speaker_role`, `speaker_email`, `speaker_phone`, `speaker_twitter`, `speaker_linkedin`, `speaker_facebook`, `speaker_img`, `speaker_bio`, `speaker_message`, `speaker_added_date`) 
    					                    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    					                ";
...
<head>
    ...
    <title>Be a Speaker ~ Bitcoin Freedom</title>
</head>
<body>
      	...
      	<div class="container">
        	<div class="row justify-content-center">
          		<div class="col-lg-8 mb-5">
          			<img src="assets/media/logo/logo-sm.png" width="40" height="80" alt="">
            		<h2 class="fw-bold">Be a <span class="d-block">SPEAKER.</span></h2>
            		Get in touch with us directly on&nbsp;
            		<a href="mailto:speaker@bitfreesummit.africa?subject=BE A SPEAKER!">speaker@bitfreesummit.africa</span></a>
          		</div>
		        <div class="col-lg-8">
		        	<span><?= $output; ?></span>
