        ...
        <div class="container">
            <div class="row justify-content-between g-5 mb-5 mb-lg-10">
                <div class="col-lg-4">
                    ...
                    <p class="mt-2 text-muted pe-lg-5">Solutions For Disempowered Economies.</p>
                    <span class="h5">
                        <a href="tel:+26773296536">+267 73 296 536</a>
                        <br>
                        <a href="tel:+233244376573">+233 24 437 6573</a>
                        <br>
                        <a href="tel:+254713076686">+254 713 076 686</a>
                        <br>
                ...
                <div class="col-lg-7">
                    <div class="row g-3 g-xl-5">
                        ...
                        <div class="col-6 col-md-4">
                          ...
                          <ul class="list-unstyled">
                                <li class="mb-1"><a href="<?= PROOT; ?>ticket" class="text-reset text-primary-hover">Get tickets</a></li>
                                <li class="mb-1"><a href="<?= PROOT; ?>be-a-speaker" class="text-reset text-primary-hover">Be a speaker</a></li>
                                <li class="mb-1"><a href="mailto:sponsor@bitfreesummit.africa?subject=BE OUR SPONSOR!" class="text-reset text-primary-hover">Be a sponsor</a></li>
                            </ul>
                        </div>
                        <div class="col-6 col-md-4">
